...
from distee.cache import BaseMessageCache, BaseMemberCache
from distee.cache.member_cache import RamMemberCache
...
class BaseClient:
    ...
    def __init__(self):
        ...
        self.member_cache: BaseMemberCache = RamMemberCache()
